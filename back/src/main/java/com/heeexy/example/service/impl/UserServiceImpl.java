...
public class UserServiceImpl implements UserService {
	...
	public JSONObject addUser(JSONObject jsonObject) {
		...
		if(roleId==4){
			...
			jsonObject.put("createdBy",jsonObject.getString("username"));
			jsonObject.put("updatedBy",jsonObject.getString("username"));
			shopsDetailsDao.addShopsDetails(jsonObject);
		}
	...
	public JSONObject updateUser(JSONObject jsonObject) {
		...
		if (roleId==4){
			...
			shopsDetailsDao.removeShopsDetails(jsonObject);
		}
